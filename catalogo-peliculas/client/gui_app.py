...
def barra_menu(root):
    ...
    menu_inicio.add_command(
        label='Eliminar Registor en DB', command=borrar_tabla)
...
class Frame(tk.Frame):
    def __init__(self, root=None):
        super().__init__(root, width=400, height=320)
        self.root = root
        self.pack()
    ...
    def campos_pelicula(self):
        ...
        self.mi_nombre = tk.StringVar()  # Esto es el que captura la entrada
        ...
        self.boton_nuevo.config(width=20, font=(
            'Arial', 12, 'bold'), fg='#DAD5D6', bg='#158545', cursor='hand2', activebackground='#35BD6F')
    ...
    def tabla_peliculas(self):
        ...
        self.tabla = ttk.Treeview(
            self, column=('Nombre', 'Duracion', 'Genero'))
        self.tabla.grid(row=4, column=0, columnspan=4, sticky='nse')

        # Scrollbar para la tabla si exede 10 registros
        self.scroll = ttk.Scrollbar(
            self, orien='vertical', command=self.tabla.yview)
        ...
        self.tabla.heading('#3', text='GENEREO')
